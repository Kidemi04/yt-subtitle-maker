...
class AppConfig:
    ...
    cookie_browser: str = ""   # chrome / firefox / edge / opera / brave / ""
    cookie_profile: str = ""   # Chrome/Firefox profile name e.g. "Profile 1", "Default"
    cookies_txt_path: str = "" # absolute path to cookies.txt file
